...
**User Priority**
(5/5) Η ΛΑ-1 είναι σημαντική καθώς οι χρήστες θα πρέπει να αποκτήσουν το προσωπικό τους username και password ώστε να έχουν πρόσβαση στο σύστημα.
...
**Περιγραφή**
Μια από τις βασικές λειτουργίες του συστήματος είναι η δυνατότητα του χρήστη να ανεβάσει ένα βίντεο καθώς. Το βίντεο αυτό μπορεί να βρίσκεται τοπικά στην συσκευή του χρήστη είτε είναι ήδη δημοσιευμένο στην πλατφόρμα youtube.
...
**Stability**
(2/5) Θα μπορούσε να συνδεθεί και με άλλες πλατφόρμες πέρα από το youtube. Επίσης οι χρήστες θα μπορούν να ανεβάσουν ένα βίντεο που έχουν στο cloud.
...
**Technical Priority**
(3/5) Η υπηρεσία μπορεί να υλοποιηθεί και να παρέχει πλήρη λειτουργικότητα ακόμα και χωρίς την υλοποίηση της ΛΑ-6.
...
**Technical Priority**
(3/5) Το σύστημα μπορεί να υλοποιηθεί και να παρέχει πλήρη λειτουργικότητα ακόμα και χωρίς την υλοποίηση της συγκεκριμένης απαίτησης.
...
**Περιγραφή**
Ο χρήστης μπορεί να προσθέσει ένα βίντεο που υπάρχει στο σύστημα σε μια ή περισσότερες προσωπικές του συλλογές πατώντας το κουμπί 'pick it' το οποίο βρίσκεται κάτω από κάθε βίντεο. Βλέπει όλες τις συλλογές του και μπορεί να επιλέξει μια ή περισσότερος στις οποίες θα ενταχθεί το βίντεο ή να δημιουργήσει μια νέα.
...
**Περιγραφή**
Ο χρήστης έχει την δυνατότητα να ορίσει τις κατηγορίες, υπο-κατηγορίες οι οποίες τον ενδιαφέρουν ώστε να παρακολουθεί όλα τα βίντεο τα οποία εντάσσονται σε αυτές. Επιπλέον, ενημερώνεται άμεσα για κάθε νέο βίντεο που προστίθεται σε αυτές τις κατηγορίες. 
...
**Technical Priority**
(5/5) Η υλοποίηση της ΛΑ-15 είναι απαραίτητη καθώς η ανάκτηση περιεχομένου με βασικό κριτήριο την κατηγορία αποτελεί έναν από τους κύριους σκοπούς της εφαρμογής.

**Stability**
(3/5) Προς το παρόν είναι εφικτή η αναζήτηση με βάση μια και μόνο κατηγορία. Στο μέλλον θα ήταν αρκετά χρήσιμη η συνδυαστική αναζήτηση (με βάση δυο ή περισσότερες κατηγορίες) 
...
**Περιγραφή**
Ο χρήστης θα πρέπει να μπορεί να προβάλλει οποιοδήποτε βίντεο βρίσκεται στο σύστημα είτε χρησιμοποιόνται τον player του συστήματος είτε μέσω του youtube.

**User Priority**
(5/5) Η ΛΑ-16 είναι σημαντική καθώς οι χρήστες θα πρέπει να μπορούν να προβάλλουν κάθε βίντεο που υπάρχει στο σύστημα.

**Technical Priority**
(5/5) Η υλοποίηση της ΛΑ-16 είναι απαραίτητη γιατί ουσιαστικά αποτελεί έναν από τους κύριους σκοπούς του συστήματος.
...
**User Priority**
(5/5) Η υλοποίηση της ΛΑ-17 είναι σημαντική για τον χρήστη καθώς επιθυμεί να ψηφίζει θετικά όλα τα βίντεο που του αρέσουν. 
...
**Technical Priority**
(3/5) Το σύστημα θα ήταν εξίσου λειτουργικό και χωρίς την υλοποίηση της ΛΑ-20. Στην περίπτωση αυτή κάθε φορά που ο χρήστης θα επιθυμούσε να ενημερωθεί για τις νέες συλλογές των φίλων του θα έπρεπε να επισκευθεί το προσωπικό τους προφίλ.
...
### ΜΛΑ-3
Σύνδεση με κοινωνικές πλατφόρμες.
...
### ΜΛΑ-5
Τύπος βίντεο που ανεβάζει ο χρήστης.
...
### ΜΛΑ-8
Οι χρήστες θα πρέπει να έχουν πρόσβαση σε όλα τα βίντεο που υπάρχουν στο σύστημα.
...
### ΜΛΑ-9
Οι συλλογές του χρήστη είναι ιδιωτικές και δεν είναι ορατές από τους υπόλοιπους χρήστες του συστήματος.
...
### ΜΛΑ-10
Ο χρήστης έχει πρόσβαση και μπορεί να δει τις συλλογές των φίλων του.
