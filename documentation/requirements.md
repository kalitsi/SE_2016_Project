...
**Technical Difficulty**
(5/5) Κάθε φορά που ο χρήστης επιλέγει να προτείνει ένα βίντεο το σύστημα θα πρέπει να ανακτά την λίστα των φίλων του και να στείλει στους επιλεγμένους χρήστες ενημερωτικό μήνυμα.Η υλοποίηση της ΛΑ-20 δεν είναι ιδιαίτερα δύσκολη.
